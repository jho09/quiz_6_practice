...
apa.cor.table(analytic.data, filename="myRegressionTable1.doc",table.number = 1)
...
# Regression table
apa.reg.table(interaction.regression, filename="myRegressionTable2.doc",table.number = 2)
...
# I get values for text this way
...
# I save using menus in RStudio. Manually include in MSWord Document
